...
export default function CreateIndustrialCourses() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100 overflow-y-auto p-4">
      ...
      <Card className="w-full max-w-5xl shadow-xl mb-10">
        <CardHeader>
        <CardTitle className="text-2xl uppercase border-4 rounded-2xl p-1 border-red-500 text-center font-bold">
  Create a New Industrial Attatchment Course
</CardTitle>
          ...
          <form onSubmit={handleSubmit} className="grid gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input  className="border-red-500 mt-1 mb-1"    type="text" name="title" id="title" placeholder="Enter course" onChange={handleChange} required />
              </div> 
...
<p className="text-xs text-yellow-600 mt-1">
  ⚠️ Do not use spaces. Use hyphens (-) to separate words.
              ...
              <div>
                ...
                <Input  className="border-red-500 mt-1 mb-1"    type="text" name="categories" id="categories" placeholder="e.g. Civil, 
Architectural,
Mechanical,
Electrical,
Bim " onChange={handleChange} required />
              ...
              <div>
                ...
                <Input  className="border-red-500 mt-1 mb-1"    type="text" name="duration" id="duration" placeholder="e.g., ৪ মাস" onChange={handleChange} required />
              </div>
              <div>
                <Label htmlFor="lessons">Lessons</Label>
                <Input  className="border-red-500 mt-1 mb-1"    type="text" name="lessons" id="lessons" placeholder="Enter number of lessons" onChange={handleChange} required />
              </div>
              <div>
                <Label htmlFor="projects">Projects</Label>
                <Input  className="border-red-500 mt-1 mb-1"    type="text" name="projects" id="projects" placeholder="Enter number of projects" onChange={handleChange} required />
              </div>
              <div>
                <Label htmlFor="photoUrl">Photo URL</Label>
               <Input  className="border-red-500 mt-1 mb-1"   
                            type="file"
                            name="photoUrl"
              ...
              <div>
                ...
                <Input  className="border-red-500 mt-1 mb-1"    type="text" name="courseFee" id="courseFee" placeholder="Enter course fee" onChange={handleChange} required />
              </div>
            </div>
            ...
            <div className="border p-4 rounded">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input  className="border-red-500 mt-1 mb-1"    type="date" name="startingDate" id="schedule.startingDate" onChange={(e) => handleNestedChange("schedule", "startingDate", e.target.value)} required />
                </div>
                <div>
                  <Label>Mode</Label>
                ...
                <div>
                  ...
                  <Input  className="border-red-500 mt-1 mb-1"    type="text" name="days" id="schedule.days" placeholder="e.g., Saturday, Monday, Wednesday" onChange={(e) => handleNestedChange("schedule", "days", e.target.value)} required />
                </div>
                <div>
                  <Label htmlFor="schedule.time">Time</Label>
                  <Input  className="border-red-500 mt-1 mb-1"    type="text" name="time" id="schedule.time" placeholder="e.g., 07:00 PM - 09:00 PM" onChange={(e) => handleNestedChange("schedule", "time", e.target.value)} required />
                </div>
              </div>
            </div>
            ...
            <div className="border p-4 rounded">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">  
                <div>
                  <Label htmlFor="overview.overviewDescription uppercase">Overview Description</Label>
                ...
                <div>
                  ...
                  <Input  className="border-red-500 mt-1 mb-1"    type="text" name="overview.videoUrl" id="overview.videoUrl" placeholder="Enter video URL" onChange={(e) => handleNestedChange("overview", "videoUrl", e.target.value)} required />
                </div>
              </div>
            </div>
            ...
            <div className="border p-4 rounded">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  ...
                  <Input  className="border-red-500 mt-1 mb-1"    type="text" name="courseIncludes.duration" id="courseIncludes.duration" placeholder="Enter duration" onChange={(e) => handleNestedChange("courseIncludes", "duration", e.target.value)} required />
                </div>
                <div>
                  <Label htmlFor="courseIncludes.weeklyLiveClasses">Weekly Live Classes</Label>
                  <Input  className="border-red-500 mt-1 mb-1"    type="text" name="courseIncludes.weeklyLiveClasses" id="courseIncludes.weeklyLiveClasses" placeholder="Enter weekly live classes" onChange={(e) => handleNestedChange("courseIncludes", "weeklyLiveClasses", e.target.value)} required />
                </div>
                <div>
                  <Label htmlFor="courseIncludes.weeklyClassHours">Weekly Class Hours</Label>
                  <Input  className="border-red-500 mt-1 mb-1"    type="text" name="courseIncludes.weeklyClassHours" id="courseIncludes.weeklyClassHours" placeholder="Enter weekly class hours" onChange={(e) => handleNestedChange("courseIncludes", "weeklyClassHours", e.target.value)} required />
                </div>
              </div>
            </div>
