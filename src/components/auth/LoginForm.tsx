...
export function LoginForm({ onSuccess, hideHeader = false }: LoginFormProps = {}) {
  ...
  return (
    <section>
      ...
      <div className=" w-full bg-gradient-to-br from-red-50 via-red-50 to-rose-70 flex items-center justify-center p-4">
        <div className=" w-full  bg-white/90 backdrop-blur-sm rounded-xl shadow-2xl overflow-hidden border border-white/20">
