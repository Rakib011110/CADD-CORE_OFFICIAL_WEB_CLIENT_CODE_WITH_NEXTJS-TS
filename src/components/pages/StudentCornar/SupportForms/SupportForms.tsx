    ...
    <div className="flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-center">
        ...
        <div className="bg-white border border-gray-300 rounded-lg p-6 shadow-lg">
          ...
          <button className="bg-red-600 text-white px-5 py-2 mt-4 rounded-md hover:bg-red-700 transition border border-red-600">
            <Link href={"https://docs.google.com/forms/d/e/1FAIpQLSdUQ5SCAbUCu1teHQ77Z035EVWIB0zzwoQ2s3ZbeOJblW2pKQ/viewform"}>
              ফর্ম পূরণ করুন
            </Link>
          </button>
        </div>
