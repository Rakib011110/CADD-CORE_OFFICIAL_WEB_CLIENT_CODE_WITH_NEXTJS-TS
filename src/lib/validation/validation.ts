...
export const InstructorformSchema = z.object({
    ...
    phone: z.string().min(11, "আপনার সঠিক ফোন নাম্বার লিখুন").max(14,"আপনার সঠিক ফোন নাম্বার লিখুন"),

    experience: z.string().min(1, "অভিজ্ঞতা নির্বাচন করুন"),
    message: z.string().min(20, "অন্তত ২০ অক্ষর লিখুন"),
    cv: z.instanceof(File).refine(file => file.size <= 5_000_000, "ফাইলের আকার ৫MB এর কম হতে হবে"),
  });
